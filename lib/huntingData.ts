...
export const huntingData: StateSeasonData[] = [
  // ─── ELK ───────────────────────────────────────────────────────────────────
  {
    ...
    notes: 'NR archery OTC eliminated west of I-25 as of 2025 — now draw-only for most of Colorado. Very limited OTC archery remains in a few eastern GMUs (east of I-25). Rifle OTC still available most units except Gunnison Basin (draw-only as of 2026). Habitat stamp ($10) required. Verify current unit status at cpw.state.co.us.',
    difficulty: 'moderate',
  },
  {
  ...
  },
  {
    ...
    oddsAt15Pts: 0.99, oddsAt20Pts: 0.99,
    notes: 'TWO systems: (1) OTC general archery permit — unlimited, on sale July 7, any-bull/spike units. NR OTC archery ~$849. (2) Limited draw tags via weighted preference points for premium units (apply Mar 19–Apr 23). Start with OTC archery while building points for premium draw units. Verify at wildlife.utah.gov.',
    difficulty: 'easy',
  },
  {
  ...
  },
  {
    ...
    notes: 'World-class elk. 10–20 year wait for premium units. NR fee ~$175 ($160 hunting license + $15 app fee). Apply for bonus points every year even if not hunting soon. Apply Jan–Feb at azgfd.com.',
    difficulty: 'very_hard',
  },
  {
  ...
  },
  {
    ...
    feeNonresident: 361, feeResident: 50,
    pointSystem: 'preference', maxPointsEst: 12, nrQuotaPct: 16,
    hasOTC: false, oddsAtZeroPts: 0.20, oddsAt5Pts: 0.55, oddsAt10Pts: 0.90,
    oddsAt15Pts: 0.99, oddsAt20Pts: 0.99,
    notes: 'NO OTC for non-residents — draw-only. Multi-season elk tags via drawing (apply Dec 1–Mar 31). NR tag ~$361 + $110 application fee. Roosevelt elk on coast, Rocky Mountain inland. Verify at wdfw.wa.gov.',
    difficulty: 'moderate',
  },
  {
